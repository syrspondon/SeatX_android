...
public class BusOutUni extends AppCompatActivity implements AdapterView.OnItemSelectedListener, View.OnClickListener {
    public Spinner spinner;
    public Button selectButton, backOut;
    public int x;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bus_out_uni);
        setTitle("Seat booking for out Uni");
        ...
        backOut.setOnClickListener(this::back);
    }
    ...
    public void onClick(View v) {
        ...
        referenceStudent.child(id).child("seatOut").setValue(seatNo);
